...
g.get_figure().savefig(
    "files/images/mimiciv_icd10/mcnemar_all.png",
    dpi=400,
    bbox_inches="tight",
)
plt.clf()

data = load_split_data(data_dir=Path(DATA_DIRECTORY_MIMICIV_ICD10), dataset=DATASET)
...
g.get_figure().savefig(
    "files/images/mimiciv_icd10/mcnemar_rare.png",
    dpi=400,
    bbox_inches="tight",
)
plt.clf()
...
g.get_figure().savefig(
    "files/images/mimiciv_icd10/mcnemar_common.png",
    dpi=400,
    bbox_inches="tight",
)
