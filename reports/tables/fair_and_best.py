...
for metric in METRICS:
    ...
    if "@" in metric:
        ...
        level1 = level1.replace("recall", "R")
...
sweep_id = "z89rf0ls"
runs = get_runs(PROJECT, {"Sweep": sweep_id})
...
print(
    styler.to_latex(
        ...
        caption="Results on MIMIC-III clean test set. Each model was trained 10 times with different seeds. We performed a McNemar's test with Bonferroni correction and found them all to be significantly different ($p < 0.001$)",
