...
print(
    styler.to_latex(
        ...
        caption="MIMIC-IV ICD-9 results. We performed a McNemar's test with Bonferroni correction and found them all to be significantly different ($p < 0.001$)",
        label="tab:mimiciv_icd9_results",
        convert_css=True,
    )
)
